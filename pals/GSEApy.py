...
class GSEApy(object):
    ...
    def __init__(self, data_source, random_sets=1000, pbar=True, case=None, control=None):
        """
    ...
    def get_pathway_df(self, standardize=True):
        ...
        for comp in self.data_source.comparisons:
            ...
            min_size = 1
            max_size = 1000
            permutation_num = self.random_sets
            ...
            try:
                ...
                # ignore errors like PermissionError: [WinError 32] The process cannot access the file because it is being used by another process: 'C:\\Users\\joewa\\AppData\\Local\\Temp\\tmp4uiu6wec\\gseapy.gsea.blank_name.log'
                pass
